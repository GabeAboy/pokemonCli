#! python2
import sqlite3
db = sqlite3.connect('C:/Users/Ember/Documents/GitHub/pokemonCli/database.db') #('C:/repos/UVM/pokemonCli/database.db') #changing for my computer you will have to change it back
